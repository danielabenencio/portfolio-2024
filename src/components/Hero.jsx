...
import profilePic from "../assets/danielaphoto.jpeg";
      ...
      <div className="flex flex-warp">
        <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
                <motion.h1 
                  ...
                  initial="hidden"
                  animate="visible"
                  className=" pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl"> Daniela Benencio</motion.h1>
                <motion.span 
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            ...
            className="rounded-xl  w-2/3 mt-10" 
            src={profilePic} 
            alt="Daniela" />
          </div>
        </div>
